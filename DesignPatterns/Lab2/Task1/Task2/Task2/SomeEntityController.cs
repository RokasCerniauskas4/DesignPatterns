...
public class SomeEntityController
{
    ...
    {
        SetStatus(id, EntityStatus.Active);
    }

    public void Deactivate(int id)
    {
        SetStatus(id, EntityStatus.Inactive);
    }

    public void Print(SomeEntity entity)
    {
        Console.WriteLine($"[{entity.Id}] {entity.Name} ({entity.Status}) - {entity.Description}");
    }
    
    public void PrintMany(IEnumerable<SomeEntity> entities)
    {
